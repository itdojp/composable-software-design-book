...
| Shadow execution | [Chapter 07](../../chapter-chapter07/) | `shadow mode`, `transformation lineage` | It is an alternate search entry for the overlap period in which legacy and replacement outputs are compared before cutover. |
...
| Transformation lineage | [Chapter 07](../../chapter-chapter07/) | `schema mapping`, `shadow mode` | It records how one integrated or replaced structure became another without losing auditability. |
| Transfer case | [Chapter 10](../../chapter-chapter10/) | [Appendix D](../../appendices/appendix-d/), `deployment approval pipeline` | It shows how the same compositional method moves into adjacent domains without creating a rival running example. |
