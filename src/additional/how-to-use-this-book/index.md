...
This path is best when you are adopting the method as a coherent design and review discipline.
...
Use this path when your immediate concern is who may approve AI-assisted work, which evidence must exist, and how execution remains auditable after approval.
...
Use this path when your team already has a delivery workflow but struggles with view consistency, variation, migration, or integration boundaries.
...
Appendix A is the notation and diagram desk reference.
Appendix B is the canonical vocabulary reference.
Appendix C maps chapters to selective external sources.
