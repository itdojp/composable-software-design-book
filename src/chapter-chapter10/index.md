...
This is the same secondary transfer cue that the Introduction and Chapters 01, 02, and 04 use in smaller form to show earlier that the method is not repository-exclusive.
