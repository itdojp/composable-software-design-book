...
The goal is to show one bounded method clearly enough that architects, review owners, and platform teams can adapt it to their own governed delivery environments.

Readers who want the versioned artifact companion can use the repository after the chapter argument is clear.
It exists to deepen inspection, not to carry the authority of the book in place of the prose.
