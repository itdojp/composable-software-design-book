...
Contributions follow the license scope of the files they modify.
...
Embedded executable snippets inside `index.md`, `src/**`, and `manuscript/ja/**` are treated as `Apache-2.0` unless a file says otherwise.
