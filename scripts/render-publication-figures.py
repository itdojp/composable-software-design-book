...
FIGURES = [
    ...
    {
        "slug": "string-diagram-fan-in",
        "width": 1320,
        "height": 560,
        "zones": [
            {"x": 40, "y": 90, "w": 560, "h": 370, "label": "Lawful fan-in", "kind": "boundary"},
            {"x": 720, "y": 90, "w": 560, "h": 370, "label": "Broken fan-in", "kind": "boundary"},
        ],
        "nodes": [
            {"id": "l_rp", "label": "Review Plan", "x": 80, "y": 240, "w": 190, "h": 64, "kind": "object"},
            {"id": "l_pol", "label": "Policy Branch", "x": 320, "y": 130, "w": 180, "h": 64, "kind": "decision"},
            {"id": "l_evd", "label": "Evidence Branch", "x": 320, "y": 330, "w": 200, "h": 64, "kind": "evidence"},
            {"id": "l_sync", "label": "Synchronized Packet", "x": 360, "y": 240, "w": 200, "h": 64, "kind": "decision"},
            {"id": "r_rp", "label": "Review Plan", "x": 760, "y": 240, "w": 190, "h": 64, "kind": "object"},
            {"id": "r_pol", "label": "Policy Branch", "x": 1000, "y": 130, "w": 180, "h": 64, "kind": "decision"},
            {"id": "r_evd", "label": "Evidence Branch", "x": 1000, "y": 330, "w": 200, "h": 64, "kind": "evidence"},
            {"id": "r_mut", "label": "Mutable Context", "x": 980, "y": 430, "w": 220, "h": 64, "kind": "object"},
            {"id": "r_sum", "label": "Unlabeled Summary", "x": 1060, "y": 240, "w": 200, "h": 64, "kind": "decision"},
        ],
        "edges": [
            {"from": "l_rp", "to": "l_pol", "label": "same identity + revision"},
            {"from": "l_rp", "to": "l_evd", "label": "same identity + revision"},
            {"from": "l_pol", "to": "l_sync", "label": "preserve policy result"},
            {"from": "l_evd", "to": "l_sync", "label": "preserve evidence"},
            {"from": "r_rp", "to": "r_pol", "label": "original plan"},
            {"from": "r_rp", "to": "r_evd", "label": "original plan"},
            {"from": "r_mut", "to": "r_evd", "label": "widen scope"},
            {"from": "r_pol", "to": "r_sum", "label": "policy result"},
            {"from": "r_evd", "to": "r_sum", "label": "summary only"},
        ],
    },
    {
    ...
    {
        "slug": "pure-core-effectful-shell",
        "width": 1320,
        "height": 560,
        "zones": [
            {"x": 40, "y": 90, "w": 520, "h": 360, "label": "Pure core", "kind": "boundary"},
            {"x": 720, "y": 90, "w": 560, "h": 360, "label": "Effectful shell", "kind": "effect"},
        ],
        "nodes": [
            {"id": "rp", "label": "Review Plan", "x": 80, "y": 240, "w": 190, "h": 64, "kind": "object"},
            {"id": "src", "label": "Scope + Route Checks", "x": 300, "y": 140, "w": 220, "h": 64, "kind": "object"},
            {"id": "ec", "label": "Evidence Completeness", "x": 300, "y": 320, "w": 220, "h": 64, "kind": "object"},
            {"id": "env", "label": "Governed Envelope", "x": 560, "y": 240, "w": 220, "h": 64, "kind": "decision"},
            {"id": "agt", "label": "Agent + Policy Tools", "x": 830, "y": 140, "w": 230, "h": 64, "kind": "effect"},
            {"id": "awr", "label": "Approval Write", "x": 1100, "y": 140, "w": 180, "h": 64, "kind": "decision"},
            {"id": "dis", "label": "Dispatch Action", "x": 1100, "y": 320, "w": 190, "h": 64, "kind": "effect"},
            {"id": "evi", "label": "Trace + Evidence", "x": 830, "y": 320, "w": 210, "h": 64, "kind": "evidence"},
        ],
        "edges": [
            {"from": "rp", "to": "src", "label": "pure checks"},
            {"from": "rp", "to": "ec", "label": "pure checks"},
            {"from": "src", "to": "env", "label": "same plan meaning"},
            {"from": "ec", "to": "env", "label": "same plan meaning"},
            {"from": "env", "to": "agt", "label": "invoke governed tools"},
            {"from": "agt", "to": "awr", "label": "produce reviewed state"},
            {"from": "awr", "to": "dis", "label": "authorize dispatch"},
            {"from": "awr", "to": "evi", "label": "emit decision evidence"},
            {"from": "dis", "to": "evi", "label": "emit execution evidence"},
        ],
    },
    {
